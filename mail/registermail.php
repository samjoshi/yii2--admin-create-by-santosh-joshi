        ...
        <td>
          <table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
              <td width='40'></td>
              <td width='600'>
               <div class="contentEditable"><img src="<?=  Yii::$app->urlManager->createAbsoluteUrl(['images/banner.jpg'])?>" width="600" height="200" /></img>
                <table width="580" border="0" cellspacing="0" bgcolor="#ffffff" cellpadding="0" align="center" style="padding:10px;" >
                        ...
                        <table width="580" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
                          ...
                          <tr>
                            <td align='left'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable" align='center'>
                               <p>Thank you for registering at Kudos - The site for the serious collector as  Your account is created and must be activated before you can use it.
To activate the account click on the following link or copy-paste it in your browser:,</p>
                                    <br>
                                    <br>
                      ...
                      <a target='_blank' class='link1' href="<?= $regLink ?>"><?= $regLink ?></a>
                                  ...
                                  <p  style='text-align:left;color:#dc2828;font-size:14px;font-weight:normal;line-height:19px;'>After activation you may login by using the following username and password:</p>
                                    ...
                                    <p  style='text-align:left;color:#000;font-size:14px;font-weight:normal;line-height:19px;'><b>Password: <?php echo trim($password,' ');?></b> </p>
...
<!-- =============================== footer ====================================== -->
   ...
   <tr>
                            <td>
                              <table width="330" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
      <tr>
                              </table>
                            </td>
                          </tr>
     ...
     <tr>
                         <td height='25' bgcolor="#000">
                             <p  style='text-align:left;color:#fff;font-size:18x;font-weight:normal;line-height:50px; text-align:center; '>Copyright © 2017 Kudos | Victoria, Australia
</p>
                         </td></tr>
