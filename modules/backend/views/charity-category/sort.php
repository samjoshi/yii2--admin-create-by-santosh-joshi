...
?>
  ...
  <script src="<?php echo Yii::$app->request->baseUrl; ?>/themes/admin/files/dist/js/jquery-ui_002.js"></script>
  <script src="<?php echo Yii::$app->request->baseUrl; ?>/themes/admin/files/dist/js/jquery-ui_002.js"></script>
...
?>
<input id="order_sort" name="sort_order" type="hidden">
<div class="row">
  <div class="col-md-6">
     <ul id="sortable">
     ...
     // echo "<pre>"; print_r($solicitorList);die;
       ...
       $clickable= Yii::$app->urlManager->createUrl(['/backend/charity-category/sort','id'=>$value['id']]);
